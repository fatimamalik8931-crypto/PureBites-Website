...
//  switch the menu over to the API in Phase 1.
//
//  `code` here == the old `id` in script.js.
// =========================================================

/** @type {Array<{code:string,category:string,name:string,price:number,tag:string,description:string,imageUrl:string}>} */
export const MENU_SEED = [
  // ---------- BURGERS ----------
  {
    code: 'b1', category: 'burgers', name: 'Pure Signature Burger', price: 750, tag: 'Chef’s Pick',
    description: 'Double smashed beef, aged cheddar, house sauce, brioche bun.',
    imageUrl: 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?auto=format&fit=crop&w=600&q=80',
  },
  {
    code: 'b2', category: 'burgers', name: 'Classic Beef Burger', price: 550, tag: '',
  ...
  {
    code: 'b3', category: 'burgers', name: 'Crispy Chicken Burger', price: 520, tag: '',
  ...
  {
    code: 'b4', category: 'burgers', name: 'Double Cheese Smash', price: 850, tag: 'Bestseller',
  ...
  {
    code: 'b5', category: 'burgers', name: 'Zinger Tower', price: 690, tag: 'Spicy',
  ...
  // ---------- SANDWICHES ----------
  {
    code: 's1', category: 'sandwiches', name: 'Grilled Chicken Sandwich', price: 450, tag: '',
  ...
  {
    code: 's2', category: 'sandwiches', name: 'Triple-Decker Club', price: 520, tag: '',
  ...
  {
    code: 's3', category: 'sandwiches', name: 'Beef Steak Sandwich', price: 620, tag: 'Popular',
  ...
  {
    code: 's4', category: 'sandwiches', name: 'Veggie Melt', price: 380, tag: '',
  ...
  // ---------- SIDES ----------
  {
    code: 'f1', category: 'sides', name: 'Loaded Fries', price: 350, tag: 'Bestseller',
  ...
  {
    code: 'f2', category: 'sides', name: 'Masala Fries', price: 250, tag: '',
  ...
  {
    code: 'f3', category: 'sides', name: 'Crispy Wings (6 pcs)', price: 480, tag: 'Spicy',
  ...
  {
    code: 'f4', category: 'sides', name: 'Onion Rings', price: 280, tag: '',
  ...
  // ---------- DRINKS ----------
  {
    code: 'd1', category: 'drinks', name: 'Fresh Lemonade', price: 200, tag: '',
  ...
  {
    code: 'd2', category: 'drinks', name: 'Mint Margarita', price: 250, tag: 'Popular',
  ...
  {
    code: 'd3', category: 'drinks', name: 'Cold Coffee', price: 300, tag: '',
